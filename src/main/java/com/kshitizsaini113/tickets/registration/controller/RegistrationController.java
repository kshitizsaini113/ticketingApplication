package com.kshitizsaini113.tickets.registration.controller;

import com.kshitizsaini113.tickets.registration.bean.Registration;
import com.kshitizsaini113.tickets.registration.repository.RegistrationRepository;
...
public class RegistrationController {
    ...
    public Registration update(@RequestBody Registration registration) {
        ...
        return registrationRepository.save(
                new Registration(existing.id(), existing.productId(), ticketCode, registration.attendeeName())
        );
    }
